...
const QUOTES = [
  ...
  { text: "習慣は第二の天性なり", author: "ことわざ" },
  { text: "石の上にも三年", author: "ことわざ" },
  { text: "為せば成る", author: "織田信長" },
  { text: "日々是修行", author: "禅宗の言葉" },
  { text: "心を鍛えよ、体はついてくる", author: "ことわざ" },
  { text: "健康は何よりの宝なり", author: "ことわざ" },
  { text: "行動は必ずしも幸福をもたらさないかもしれない。しかし、行動なくして幸福はない", author: "ベンジャミン・ディズレーリ" },
  { text: "始めることが成功の半分である", author: "マーク・トウェイン" },
  { text: "完璧を待っていたら、ずっと何もできない", author: "シェリー・サンドバーグ" },
  { text: "昨日の失敗は、今日の成功の種である", author: "本田宗一郎" },
  { text: "やってみせ、言って聞かせて、させてみせ、ほめてやらねば、人は動かじ", author: "山本五十六" },
  { text: "勝つことより、負けないこと。負けないことより、諦めないこと", author: "野球の格言" },
  { text: "今日の一歩が、一年後の自分をつくる", author: "FitStamp" },
  { text: "動く体に、停滞した心は宿らない", author: "FitStamp" },
  { text: "記録は、未来の自分への手紙だ", author: "FitStamp" },
  { text: "続けることに意味がある。完璧である必要はない", author: "ジェームズ・クリアー" },
  { text: "小さな習慣が、大きな結果を生む", author: "ジェームズ・クリアー" },
  { text: "我慢の次に来るものは、自信だ", author: "スポーツの格言" },
  { text: "準備に失敗した者は、本番に失敗する", author: "ことわざ" },
  { text: "苦しいときほど、前を向け", author: "野球の格言" },
  { text: "限界は、心が決める", author: "スポーツの格言" },
  { text: "汗は嘘をつかない", author: "ことわざ" },
  { text: "今日できることを明日に延ばすな", author: "ベンジャミン・フランクリン" },
  { text: "動けば、風が吹く", author: "スポーツの格言" },
];
